...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String TestingComponent= _Prefix + TestingComponent1Model._TYPECODE + _Suffix;
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String Details="pages/custom/manuPage";
				String NewManufacturer="pages/custom/addManu";
				String SaveManufacturer="pages/custom/saveManu";
			}
			interface one{
				String MANU="pages/custom/man";
			}
			interface OneStudent
			{
				String ONE="pages/custom/oneStudent";
			}
			interface AllStudent
			{
				String ALL="pages/custom/allStudent";
				String NewStudent="pages/custom/addStudent";
				String savedStudent="pages/custom/saveStudent";
				String REM="pages/custom/removeStudent";
			}
			interface AllStudentPagination
			{
				String ALLPAGE="pages/custom/allStudentPagination";
			}

			interface Paging
			{
				String AllByPagination="pages/custom/manuPagination";
			}
			interface PagingOrder
			{
				String AllByPaginationOrder="pages/custom/manuPagination1";
			}
			interface OneTeacher
			{
				String oneStu="pages/practice/oneStu";
				String oneStu1="pages/practice/oneStu1";
			}
			interface Customers
			{
				String AllCustomers="pages/practice/allCus";
			}
		}
