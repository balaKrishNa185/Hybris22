...
/**
 * Global class for all BalaCore constants. You can add global constants for your extension into this class.
 */
public final class BalaCoreConstants extends GeneratedBalaCoreConstants
{
	public static final String EXTENSIONNAME = "balacore";


	private BalaCoreConstants()
	{
		//empty
	}
